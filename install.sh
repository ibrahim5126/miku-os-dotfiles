...
cp "$DOTFILES_DIR/miku_mascot.py" "$HOME/miku_mascot.py"
chmod +x "$HOME/miku_mascot.py"
...
echo ""
echo "Voice greetings require VOICEVOX running locally (http://localhost:50021)."
